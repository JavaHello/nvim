...
M.maplsp = function(bufnr)
    ...
    map('n', 'gD', '<cmd>Trouble lsp_type_definitions<CR>', opt)
    -- mapbuf('n', 'gi', '<cmd>lua vim.lsp.buf.implementation()<CR>', opt)
    map('n', 'gi', '<cmd>Trouble lsp_implementations<CR>', opt)
    map('n', '<leader>gi', '<cmd>Telescope lsp_implementations<CR>', opt)
    ...
    map('n', '<leader>sw', '<cmd>Telescope lsp_dynamic_workspace_symbols<CR>', opt)
    map('n', '<leader>sd', '<cmd>Telescope lsp_document_symbols<CR>', opt)
    -- diagnostic
