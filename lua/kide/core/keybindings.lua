...
M.maplsp = function(client, bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>gi", "<cmd>Telescope lsp_implementations<CR>", opt)
	-- mapbuf('n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>', opt)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", "<cmd>Trouble lsp_references<CR>", opt)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>gr", "<cmd>Telescope lsp_references<CR>", opt)
